...
public class YellowHealthArcher : MonoBehaviour
{
    ...
    private void Update()
    {
        YellowArcherHPbar = GameObject.Find("YellowArcherHPbar");
    }
    void Start()
    {
    ...
    void OnParticleCollision(GameObject other)
    {
        if (other.name == "Projectile 25(Clone)")
        {
            ...
            if (health <= 0)
            {
                ...
                GameObject.Instantiate(Yellowdeath, a, Quaternion.identity);
